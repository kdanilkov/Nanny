...
public class LeftNavAdapter extends BaseAdapter
{
	...
	/** The items. */
	private String titles[] = {"Bank / Cards", "Wishes", "Predefined Payments", "Transactions", "Application Settings"};
	...
	/** The icons. */
	private int icons[] = { R.drawable.ic_bank, R.drawable.ic_wish,	R.drawable.ic_payment, R.drawable.ic_transaction, R.drawable.ic_setting};
